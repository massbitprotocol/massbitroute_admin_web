...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    dapi: {
       ...
       * The set of oracles.
       **/
      oracles: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> &
        QueryableStorageEntry<ApiType, []>;
      projects: AugmentedQuery<
        ApiType,
        (
          arg: LocalRuntimeMassbitId | string | Uint8Array,
        ) => Observable<Option<PalletDapiProject>>,
        [LocalRuntimeMassbitId]
      > &
        QueryableStorageEntry<ApiType, [LocalRuntimeMassbitId]>;
    ...
    dapiStaking: {
       ...
       **/
      blockRewardAccumulator: AugmentedQuery<
        ApiType,
        () => Observable<PalletDapiStakingRewardInfo>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      /**
      ...
      forceEra: AugmentedQuery<
        ApiType,
        () => Observable<PalletDapiStakingForcing>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      /**
      ...
      generalEraInfo: AugmentedQuery<
        ...
        ) => Observable<Option<PalletDapiStakingEraInfo>>,
        [u32]
      > &
      ...
      generalStakerInfo: AugmentedQuery<
        ...
        (
          ...
          arg2: LocalRuntimeMassbitId | string | Uint8Array,
        ) => Observable<PalletDapiStakingStakerInfo>,
        [AccountId32, LocalRuntimeMassbitId]
      > &
        QueryableStorageEntry<ApiType, [AccountId32, LocalRuntimeMassbitId]>;
      /**
      ...
      ledger: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<PalletDapiStakingAccountLedger>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      providerEraStake: AugmentedQuery<
        ApiType,
        (
          arg1: LocalRuntimeMassbitId | string | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array,
        ) => Observable<Option<PalletDapiStakingProviderStakeInfo>>,
        [LocalRuntimeMassbitId, u32]
      > &
        QueryableStorageEntry<ApiType, [LocalRuntimeMassbitId, u32]>;
      /**
       * Registered provider information
       **/
      registeredProviders: AugmentedQuery<
        ApiType,
        (
          arg: LocalRuntimeMassbitId | string | Uint8Array,
        ) => Observable<Option<PalletDapiStakingProviderInfo>>,
        [LocalRuntimeMassbitId]
      > &
        QueryableStorageEntry<ApiType, [LocalRuntimeMassbitId]>;
      /**
