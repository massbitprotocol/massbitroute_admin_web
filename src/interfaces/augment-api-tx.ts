...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    blockReward: {
       ...
       **/
      setConfig: AugmentedSubmittable<
        (
          config:
            | PalletBlockRewardDistributionConfig
            | { providersPercent?: any; validatorsPercent?: any }
            | string
            | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [PalletBlockRewardDistributionConfig]
    ...
    dapi: {
      addChainId: AugmentedSubmittable<
        (chainId: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [Bytes]
      >;
      addRegulator: AugmentedSubmittable<
        (
          accountId: AccountId32 | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      >;
      depositProject: AugmentedSubmittable<
        (
          projectId: DevnetRuntimeMassbitId | string | Uint8Array,
          deposit: Compact<u128> | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeMassbitId, Compact<u128>]
      >;
      depositProvider: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
          deposit: Compact<u128> | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeMassbitId, Compact<u128>]
      >;
      registerProject: AugmentedSubmittable<
        (
          projectId: DevnetRuntimeMassbitId | string | Uint8Array,
          chainId: Bytes | string | Uint8Array,
          deposit: Compact<u128> | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeMassbitId, Bytes, Compact<u128>]
      >;
      registerProvider: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
          providerType:
            | PalletDapiProviderType
      ...
      >;
      removeChainId: AugmentedSubmittable<
        (chainId: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [Bytes]
      >;
      removeRegulator: AugmentedSubmittable<
        (
          accountId: AccountId32 | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      >;
      reportProviderOffence: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
          reason:
            | PalletDapiProviderDeactivateReason
        ...
        [DevnetRuntimeMassbitId, PalletDapiProviderDeactivateReason]
      >;
      submitProjectUsage: AugmentedSubmittable<
        (
          projectId: DevnetRuntimeMassbitId | string | Uint8Array,
          usage: u128 | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeMassbitId, u128]
      >;
      unregisterProvider: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeMassbitId]
    ...
    dapiStaking: {
       ...
       **/
      claimDelegator: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeMassbitId]
       ...
       **/
      claimProvider: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
          era: Compact<u32> | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeMassbitId, Compact<u32>]
      >;
      /**
       ...
       * unbonded.
       **/
      delegatorUnstake: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
          amount: Compact<u128> | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
       ...
       **/
      delegatorWithdrawUnregistered: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeMassbitId]
      >;
      providerBondLess: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
          amount: Compact<u128> | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeMassbitId, Compact<u128>]
      >;
      providerBondMore: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
          amount: Compact<u128> | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
       ...
       **/
      providerWithdrawUnregistered: AugmentedSubmittable<
        (
          providerId: DevnetRuntimeMassbitId | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeMassbitId]
      >;
      setBlocksPerEra: AugmentedSubmittable<
        (
    ...
    session: {
      ...
      setKeys: AugmentedSubmittable<
        (
          keys:
            | DevnetRuntimeSessionKeys
            | { aura?: any; grandpa?: any; imOnline?: any }
            | string
            | Uint8Array,
          proof: Bytes | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [DevnetRuntimeSessionKeys, Bytes]
      >;
      /**
       * Generic tx
       **/
    ...
    utility: {
      ...
      dispatchAs: AugmentedSubmittable<
        ...
        [DevnetRuntimeOriginCaller, Call]
      >;
      /**
       * Generic tx
       **/
    ...
    validatorSet: {
      ...
      addValidator: AugmentedSubmittable<
        (
          validatorId: AccountId32 | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      >;
      /**
