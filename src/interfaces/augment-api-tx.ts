  ...
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    dapi: {
      ...
      registerProvider: AugmentedSubmittable<
        ...
        [LocalRuntimeMassbitId, PalletDapiProviderType, Bytes, Compact<u128>]
      >;
      ...
      >;
      submitProviderReport: AugmentedSubmittable<
        (
          providerId: LocalRuntimeMassbitId | string | Uint8Array,
          requests: u64 | AnyNumber | Uint8Array,
          successRate: u32 | AnyNumber | Uint8Array,
          averageLatency: u32 | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [LocalRuntimeMassbitId, u64, u32, u32]
      >;
    ...
    dapiStaking: {
       ...
       **/
      claimOperator: AugmentedSubmittable<
        (
          providerId: LocalRuntimeMassbitId | string | Uint8Array,
          era: Compact<u32> | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [LocalRuntimeMassbitId, Compact<u32>]
      >;
      /**
      ...
      stake: AugmentedSubmittable<
        ...
        [LocalRuntimeMassbitId, Compact<u128>]
      >;
      /**
       ...
       **/
      withdrawFromUnregisteredOperator: AugmentedSubmittable<
        (
          providerId: LocalRuntimeMassbitId | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [LocalRuntimeMassbitId]
       ...
       **/
      withdrawFromUnregisteredStaker: AugmentedSubmittable<
        (
          providerId: LocalRuntimeMassbitId | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [LocalRuntimeMassbitId]
       ...
       **/
      withdrawUnstaked: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >;
      /**
